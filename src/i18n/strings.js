...
export const STR = {
    ar: {
      ...
      "feat.support_t": "دعم سريع", "feat.support_d": "نجيب على استفساراتك بسرعة",
      // الفئات
      ...
      // شريط الفئات الفرعية (الأصناف الفرعية نفسها تُدار من لوحة الأدمن الآن)
      "catstrip.toys": "الألعاب",
      // منتجات مختارة
      ...
      "footer.wa": "📞 الهاتف", "footer.email": "✉️ البريد الإلكتروني",
      ...
      "shop.chip_all": "الكل", "shop.subcats": "الأصناف", "shop.chip_toys": "🧸 ألعاب", "shop.chip_school": "🎒 أدوات مدرسية",
      ...
      "pdp.add": "🛒 أضف إلى السلة", "pdp.buy": "⚡ اطلب الآن", "pdp.related": "منتجات مشابهة",
      ...
      "cart.submit": "✅ تأكيد الطلب", "cart.sending": "جارٍ إرسال الطلب...", "cart.save_err": "تعذّر إرسال الطلب. تحقق من اتصالك بالإنترنت ثم أعد المحاولة.",
      "cart.ok_t": "تم استلام طلبك بنجاح! 🎉", "cart.ok_p": "سنتصل بك قريباً على رقم هاتفك لتأكيد الطلب وموعد التوصيل.", "cart.ok_ref": "رقم طلبك", "cart.ok_btn": "متابعة التسوّق", "cart.cod_note": "💵 الدفع عند الاستلام — لا حاجة لبطاقة بنكية",
      ...
      "about.why4": "دعم سريع عبر الهاتف للإجابة على كل استفساراتك.",
      ...
      "about.c4_t": "دعم سريع", "about.c4_d": "فريقنا جاهز للرد على استفساراتك بسرعة.",
      ...
      "faq.q1": "كيف أطلب من الموقع؟", "faq.a1": "اختر منتجاتك وأضِفها إلى السلة، ثم اذهب إلى صفحة السلة واملأ اسمك ورقم هاتفك وولايتك، ثم اضغط \"تأكيد الطلب\". سيصلنا طلبك فوراً ونتصل بك هاتفياً لتأكيده.",
      ...
      "faq.q4": "كم تستغرق مدة التوصيل؟", "faq.a4": "عادة من 2 إلى 5 أيام عمل حسب الولاية وشركة التوصيل. نتصل بك هاتفياً لتأكيد الطلب وموعد التسليم التقريبي.",
      "faq.q5": "هل يمكنني إرجاع أو استبدال منتج؟", "faq.a5": "نعم، يمكنك طلب الاستبدال خلال 48 ساعة من الاستلام في حال وجود عيب في المنتج، بشرط أن يكون بحالته الأصلية. تواصل معنا هاتفياً لترتيب ذلك.",
    ...
    fr: {
      ...
      "feat.support_t": "Support rapide", "feat.support_d": "Nous répondons vite à vos questions",
      ...
      "footer.wa": "📞 Téléphone", "footer.email": "✉️ E-mail",
      ...
      "shop.chip_all": "Tout", "shop.subcats": "Catégories", "shop.chip_toys": "🧸 Jouets", "shop.chip_school": "🎒 Fournitures",
      ...
      "pdp.add": "🛒 Ajouter au panier", "pdp.buy": "⚡ Commander maintenant", "pdp.related": "Produits similaires",
      ...
      "cart.submit": "✅ Confirmer la commande", "cart.sending": "Envoi de la commande...", "cart.save_err": "Impossible d'envoyer la commande. Vérifiez votre connexion puis réessayez.",
      "cart.ok_t": "Commande reçue avec succès ! 🎉", "cart.ok_p": "Nous vous appellerons bientôt pour confirmer la commande et la date de livraison.", "cart.ok_ref": "Numéro de commande", "cart.ok_btn": "Continuer mes achats", "cart.cod_note": "💵 Paiement à la livraison — pas de carte bancaire requise",
      ...
      "about.why4": "Support rapide par téléphone pour toutes vos questions.",
      ...
      "about.c4_t": "Support rapide", "about.c4_d": "Notre équipe est prête à répondre rapidement.",
      ...
      "faq.q1": "Comment commander sur le site ?", "faq.a1": "Choisissez vos produits, ajoutez-les au panier, puis allez sur la page Panier et remplissez votre nom, téléphone et wilaya, puis cliquez sur « Confirmer la commande ». Votre commande nous parvient immédiatement et nous vous appelons pour la confirmer.",
      ...
      "faq.q4": "Quel est le délai de livraison ?", "faq.a4": "Généralement de 2 à 5 jours ouvrables selon la wilaya et le transporteur. Nous vous appelons pour confirmer la commande et la date approximative.",
      "faq.q5": "Puis-je retourner ou échanger un produit ?", "faq.a5": "Oui, vous pouvez demander un échange sous 48 h après réception en cas de défaut, à condition que le produit soit dans son état d'origine. Contactez-nous par téléphone.",
    ...
    en: {
      ...
      "feat.support_t": "Fast support", "feat.support_d": "We answer your questions fast",
      ...
      "footer.wa": "📞 Phone", "footer.email": "✉️ Email",
      ...
      "shop.chip_all": "All", "shop.subcats": "Categories", "shop.chip_toys": "🧸 Toys", "shop.chip_school": "🎒 Supplies",
      ...
      "pdp.add": "🛒 Add to cart", "pdp.buy": "⚡ Order now", "pdp.related": "Related products",
      ...
      "cart.submit": "✅ Confirm order", "cart.sending": "Sending your order...", "cart.save_err": "Couldn't send your order. Check your connection and try again.",
      "cart.ok_t": "Your order was received! 🎉", "cart.ok_p": "We'll call you soon to confirm the order and delivery date.", "cart.ok_ref": "Your order number", "cart.ok_btn": "Continue shopping", "cart.cod_note": "💵 Cash on delivery — no bank card required",
      ...
      "about.why4": "Fast phone support for all your questions.",
      ...
      "about.c4_t": "Fast support", "about.c4_d": "Our team is ready to reply quickly.",
      ...
      "faq.q1": "How do I order from the site?", "faq.a1": "Choose your products and add them to the cart, then go to the Cart page and fill in your name, phone, and wilaya, then click \"Confirm order\". We receive your order instantly and call you to confirm it.",
      ...
      "faq.q4": "How long does delivery take?", "faq.a4": "Usually 2 to 5 working days depending on the wilaya and courier. We call you to confirm the order and the approximate delivery date.",
      "faq.q5": "Can I return or exchange a product?", "faq.a5": "Yes, you can request an exchange within 48 hours of delivery if the product is defective, provided it's in its original condition. Contact us by phone to arrange it.",
